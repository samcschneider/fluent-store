...
(defn ^:export init []
  ...
  (ev/locations-event-loop :ecom/locations-received :ecom/locations-error)
  (ev/store-inventory-event-loop :ecom/store-inventory-received :ecom/store-inventory-error)
  (ev/warehouse-inventory-event-loop :ecom/warehouse-inventory-received :ecom/warehouse-inventory-error)
